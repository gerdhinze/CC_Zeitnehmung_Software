function bt_lastDuel(src,callbackdata)
    ...
    if isempty(data.TNData)
        errordlg(['No Data loaded!']);
           ...
           if (data.bFreilos && (data.idx == 2)) 
               ...
               set(findall(src.Parent,'Tag','rndOneSp1DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndOneSp2DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndOneDT'),'Value','00:00.000');

               set(findall(src.Parent,'Tag','rndTwoSp1DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndTwoSp2DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndTwoDT'),'Value','00:00.000');

               set(findall(src.Parent,'Tag','rndThreeSp1DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndThreeSp2DT'),'Value','00:00.000');
               set(findall(src.Parent,'Tag','rndThreeDT'),'Value','00:00.000');

               set(findall(src.Parent,'Tag','MeterOneDT'),'Value',num2str(0));        
               set(findall(src.Parent,'Tag','MeterTwoDT'),'Value',num2str(0)); 
               set(findall(src.Parent,'Tag','MeterThreeDT'),'Value',num2str(0));
               ...
               set(findall(0,'Tag','lblTimeOneSp1DODuelDisp'),'Text',string(data.TNData.firRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeOneSp2DODuelDisp'),'Text',string(data.TNData.firRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeOneDODuelDisp'),'Text',string(data.TNData.firRndBO(data.idx)));

               set(findall(0,'Tag','lblTimeTwoSp1DODuelDisp'),'Text',string(data.TNData.secRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeTwoSp2DODuelDisp'),'Text',string(data.TNData.secRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeTwoDODuelDisp'),'Text',string(data.TNData.secRndBO(data.idx)));

               set(findall(0,'Tag','lblTimeThreeSp1DODuelDisp'),'Text',string(data.TNData.thiRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeThreeSp2DODuelDisp'),'Text',string(data.TNData.thiRndBO(data.idx)));
               set(findall(0,'Tag','lblTimeThreeDODuelDisp'),'Text',string(data.TNData.thiRndBO(data.idx)));
            
               
           elseif (data.bFreilos & (data.idx == 1)) 
